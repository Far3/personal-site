  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-green-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <a href="/">
            <h1 v-show="theme == 'theme-dark'" class="text-4xl font-bold text-white">Franklyn Roth</h1>
            <h1 v-show="theme == 'theme-light'" class="text-4xl font-bold">Franklyn Roth</h1>
          </a>
        </div>
    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="https://www.youtube.com/channel/UCCIJ09IZaNYCCacVP0YrZMw" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/Far3" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://twitter.com/franklynroth" target="_blank" class="text-white hover:text-gray-400">
