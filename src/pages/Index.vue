<template>
  <Layout>
    ...
    <div class="overflow-x-hidden">
      <div class="projects container-inner mx-auto text-xl border-gray-500 border-b py-16 mb-16 relative">
        ...
        <ul class="text-lg sm:text-xl">
          <li class="checkmark mb-6">
            <div><a href="https://awesome-keller-8a6319.netlify.app/" target="_blank" rel="noopener">Rental Property Calculator</a></div>
            <div class="text-lg text-gray-600">A rental property calculator that tells the user the cap rate, cash on cash retrurn and more. Helping me decide if I purchase a home or keep renting after the #coivd. Built with Vue.</div>
          </li>
          <li class="checkmark mb-6">
            <div><a href="https://franks-cookbook.firebaseapp.com/" target="_blank" rel="noopener">Franks Cookbook</a></div>
